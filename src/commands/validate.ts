...
export function registerValidateCommand(
	...
	const command = vscode.commands.registerCommand('urls-le.postProcess.validate', async () => {
		...
		try {
			...
			deps.notifier.showInfo(`Validation complete: ${validCount} valid, ${invalidCount} invalid`)
