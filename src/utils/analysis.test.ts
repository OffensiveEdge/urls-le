...
describe('URL Analysis', () => {
	describe('analyzeUrls', () => {
		...
		it('should detect duplicate URLs', () => {
			const urls = ['https://example.com/page1', 'https://example.com/page1', 'https://example.com/page2']
		...
		it('should detect suspicious URLs', () => {
			const urls = ['https://bit.ly/short-url', 'https://tinyurl.com/abc123', 'https://example.com/normal']
		...
		it('should not include accessibility analysis when disabled', () => {
			const config = { ...createTestConfig(), analysisIncludeAccessibility: false }
			const urls = ['https://example.com/page']
