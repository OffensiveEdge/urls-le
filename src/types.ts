...
export type RecoveryAction = 'retry' | 'fallback' | 'user-action' | 'skip' | 'abort' | 'truncate'
...
export type UrlProtocol = 'http' | 'https' | 'ftp' | 'file' | 'mailto' | 'tel' | 'unknown'
...
export type FileType = 'markdown' | 'html' | 'css' | 'javascript' | 'typescript' | 'json' | 'yaml' | 'yml' | 'unknown'
...
export type { ErrorHandler, ErrorLogger, ErrorNotifier } from './utils/errorHandling'
